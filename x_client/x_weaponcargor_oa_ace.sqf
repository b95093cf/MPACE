...
if (isNil "x_ranked_weapons") then {
		_x_ranked_weapons_w = [
			[
				// private rifles
				[
					["M16A2",5],["FN_FAL",5],["Sa58P_EP1",5],["Sa58V_EP1",5],["LeeEnfield",5],["ACE_MP5A4",5],["ACE_UMP45",5],["ACE_UMP45_SD",5]
				],
				...
				[
					...
					["ACE_M4A1_Eotech",5],["ACE_HK416_D10",5],["ACE_G3A3",5]
				],
				...
				[
					...
					["ACE_SOC_M4A1_GL_EOTECH",5],["ACE_SOC_M4A1_SD_9",5],["ACE_SOC_M4A1_GL_AIMPOINT",5],["ACE_M4A1_Aim_SD",5],["ACE_HK416_D10_SD",5],["ACE_HK416_D14",5],["ACE_G3SG1",5]
				],
				...
				[
					...
					["ACE_HK416_D14_SD",5],["ACE_HK416_D14_COMPM3",5]
				],
	...
	{d_misc_store setVariable [_x,[]]} forEach ["PRIVATE","CORPORAL","SERGEANT","LIEUTENANT","CAPTAIN","MAJOR","COLONEL"];
	...
	x_ranked_weapons = if (d_player_faction in ["USMC", "CDF", "BIS_US", "BIS_CZ", "BIS_GER"]) then {_x_ranked_weapons_w} else {_x_ranked_weapons_e};
