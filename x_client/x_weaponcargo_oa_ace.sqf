...
if (d_player_faction in ["USMC", "CDF", "BIS_US", "BIS_CZ", "BIS_GER","ACE_USARMY","ACE_BLUFOR_USARMY","ACE_BLUFOR_USMC_Desert"]) then {
	...
	__awc(ACE_Javelin_CLU,2)
	__awc(ACE_M47_Daysight,5)
	__awc(ACE_MX2A,1)
	...
	__amc(ACE_10Rnd_127x99_Raufoss_m107,10)
	__amc(ACE_5Rnd_25x59_HEDP_Barrett,10)
	__amc(ACE_20Rnd_762x51_SB_M110,10)
	__amc(ACE_20Rnd_762x51_S_M110,10)
	__amc(ACE_20Rnd_762x51_T_M110,10)
	__amc(ACE_5Rnd_127x99_B_TAC50,10)
	__amc(ACE_5Rnd_127x99_S_TAC50,10)
	__amc(ACE_5Rnd_127x99_T_TAC50,10)
